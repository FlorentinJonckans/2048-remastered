...
class RenderArea(QWidget):
    ...
    def paintEvent(self,event):
        ...
        for i in range (4):
            for j in range (4):
                #sélectionne dans le dossier Image, l'image 1 correspondant à une case noire.
                if jeu.Tab2[i][j]==1:
                    image=QImage()
...
class Window6(QMainWindow):
    ...
    def keyPressEvent(self,event):
        ...
        if (jeu.win4(jeu.Tab)==False) and (jeu.lose(jeu.Tab)==False) :
            ...
            if event.key()==Qt.Key_Left and (jeu.check(jeu.Tab,"Left")) :
                ...
                #x est une variable qui ,à une certaine valeur , permet changer 
                #les emplacement des cases cachées
                jeu.x=jeu.x+1
